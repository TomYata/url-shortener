@if ($paginator->hasPages())
    ...
    <div class="mt-2 text-center text-muted" style="font-size:0.95rem;">
        Affichage de {{ ($paginator->currentPage() - 1) * $paginator->perPage() + 1 }} à
        {{ min($paginator->currentPage() * $paginator->perPage(), $paginator->total()) }} sur
